...
# python3 -u DRP/src/drp_full_model.py --machine mist --train_file CTRP_AAC_MORGAN_512.hdf --optimize 1 --max_num_epochs 30 --init_cpus 32 --init_gpus 4 --gpus_per_trial 1 --num_samples 16 --n_folds 5  --data_types mut cnv exp --name_tag HyperOpt_DRP_CTRP_ResponseOnly_EncoderTrain_Split_CELL_LINE_NoBottleNeck_NoTCGAPretrain_drug_mut_cnv_exp --cv_subset_type cell_line --stratify 1 --bottleneck 0 --full 1 --encoder_train 1 --pretrain 0
# python3 -u DRP/src/drp_full_model.py --machine mist --train_file CTRP_AAC_MORGAN_512.hdf --optimize 1 --max_num_epochs 30 --init_cpus 32 --init_gpus 1 --gpus_per_trial 1 --num_samples 1 --n_folds 5  --data_types drug --name_tag HyperOpt_DRP_CTRP_ResponseOnly_EncoderTrain_Split_CELL_LINE_NoBottleNeck_NoTCGAPretrain_drug_mut_cnv_exp --cv_subset_type cell_line --stratify 1 --bottleneck 0 --full 1 --encoder_train 1 --pretrain 0 --random_morgan 1 --merge_method 'concat' --global_code_size 512