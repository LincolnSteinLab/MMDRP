...
python3 DRP/src/ccle_embed_hypopt_pytorch.py --machine mist --train 1 --max_num_epochs 100 --name_tag optimal_autoencoders --loss_type rmse --data_type ${DATA_TYPE} --omic_standardize