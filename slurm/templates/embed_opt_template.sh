...
python3 DRP/src/ccle_embed_hypopt_pytorch.py --machine mist --init_cpus 40 --init_gpus 1 --gpus_per_trial 0.2 --max_num_epochs 100 --n_folds 5 --data_type ${DATA_TYPE} --num_samples 100 --loss_type rmse --omic_standardize